...
extern float64 Wm_sigma_weight_1x9[9];
extern float64 Wc_sigma_weight_1x9[9];
extern float64 u_curr_system_input_4x1[4]; 

//System input previous u(k)
extern float64 u_prev_system_input_4x1[4];

//System output measurement y(k)
extern float64 y_curr_system_meas_2x1[2];

//System output predicted y_m(k|k-1)
extern float64 y_mean_system_predict_2x1[2];

//System states: x(k), x(k-1), x(k|k-1) common array for all 
extern float64 x_system_states_4x1[4];

extern float64 x_system_states_ic_4x1[4];

extern float64 x_system_states_correction_4x1[4];
